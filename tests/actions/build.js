...
describe('spm build test', function() {
  ...
  it('test unDepsConfig module build', function(done) {
  ...
  it('test invalidName module build ', function(done) {
  ...
  it('test relative module build ', function(done) {
  ...
  it('test module which define contain space', function(done) {
  ...
  it('test module require', function(done) {
    executeBuildAction(sampleModuleDir, function(model) {
  ...
  it('test require async', function(done) {
    executeBuildAction(sampleModuleDir, function(model) {
