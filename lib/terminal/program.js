...
exports.registerExtension = function(name, executable, description) {
  var cmd = new Command(name, executable, description)
  extensions.push(cmd)
  return cmd
}

exports.registerBuiltin = function(name, executable, description) {
  var cmd = new Command(name, executable, description)
  builtins.push(cmd)
  return cmd
}

exports.listExtensions = function() {
  return extensions
}

exports.listBuiltin = function() {
  return builtins
}
