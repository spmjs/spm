...
Plugin.prototype.execute = function(project, argv, callback) {
  var that = this;
  this.argv = argv;
...
Plugin.prototype.end = function() {
  console.log('SPM ' + this.name + ' plugin execution successfully!');
  //console.empty();
};
...
// 注册参数,方便提示.
Plugin.prototype.registerArgs = function(opts) {
