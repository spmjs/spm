...
Action.prototype.run = function(options, callback) {
  ...
  if (arguments.length === 1) {
    ...
    Object.keys(this.argv).forEach(function(arg) {
...
Action.prototype.initPlugins = function(model) {
  var opts = this.opts;
  var argv = opts.argv;
  this.plugins = PluginConfig.getPlugins(this.name, model.type, argv.only, model.getConfig('plugins')).
      map(function(plugin) {
            plugin.setOpts(opts);
            return plugin;
      });
