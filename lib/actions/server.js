...
// Create a node-static server instance to serve the current directory folder
//
...
function addModule(modulePath, req, res) {
  ...
  tar.extract(req, temp, function() {
    ...
    // 获取模块部署目录.
    var modulePath = getModulePath(tempModuleDir, modulePath);
...
console.info('queryPath---->', queryPath)
