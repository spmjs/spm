...
ModuleQueue.addQueue = function(moduleName) {
  var q = this.qs[moduleName];
  if (!q) {
    q = this.qs[moduleName] = async.queue(function(moduleInfo, callback) {
...
function registerModuleInfo(moduleTarPath, config) {
  // read info.json
