...
Install.MESSAGE = {
  ...
  DESCRIPTION: 'Install a module with its dependencies automatically.',
...
Install.prototype.run = function(callback) {
  ...
  var instance = this;
  var names = this.modules;

  names.forEach(function(name) {
    instance.getMeta(name, function(err, meta) {
      if (err) {
        callback(err);
      }
      else {
...
Install.prototype.getMeta = function(arg, callback) {
  var parts = arg.split('@');
  var name = parts[0];
  var version = parts[1];
  var instance = this;
