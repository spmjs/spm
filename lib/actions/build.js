...
var opts = require('../utils/opts.js').get('build', 'BUILD CMD MODULE: Usage: spm build:');
...
Build.prototype.run = function(callback) {
  ...
  var projectModel = ProjectFactory.getProjectModel(action, process.cwd(), function(projectModel) {
    ...
    executePlugins(projectModel, function(err) {
      if (err) {
        console.segm();
...
var executePlugins = function(projectModel, callback) {
