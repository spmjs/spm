...
Build.prototype.registerArgs = function() {
  ...
  opts.option('--src <src>', 'set src directory.');
  opts.option('--source <source>', 'set source server.');
  opts.option('--version <version>', 'set module version.');
  opts.option('--source-files <source-files>', 'set directory which need to compile.');
  opts.option('--throwErrorOnDepNotFound <throwErrorOnDepNotFound>',
          'throw error when dependencies not found.', false);
  opts.option('--with-debug <with-debug>', 'add debug file.');
};
