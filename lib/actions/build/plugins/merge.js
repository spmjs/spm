...
module.exports = function(project, callback) {
  ...
  if (project.compress === 'closure') {
    project.compress = require('../compress/closure.js');
  } else {
    project.compress = require('../compress/uglify.js') 
  }
...
Resource.prototype.writeMobileCode = function() {
