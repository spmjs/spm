...
function _build(tmpl) {
  ...
  parseTemplate(tmpl, function(o) {
    ...
    if (path.existsSync(src)) {
      console.info('');
      console.info('%s already exists, ignore.', src);
      console.info('Update version information in the transport.js ');
      console.info('if you want to upgrade to a new version.');
      console.info('');
      return;
    }
