...
/**
 * Loads seajs module in node environment.
 * @param {string} inputFile The file to run.
 * @param {string} base The base directory.
 */
exports.run = function(inputFile, base) {
  base = base || require('./config').modulesDir;
  var code = fs.readFileSync(inputFile, 'utf-8');
  require('vm').runInNewContext(code, createSandbox(inputFile, {}, base));
};
