...
exports.alias2id = function(name, pkg) {
  // relative name: ./class
  if (name.charAt(0) === '.') {
...
exports.pkg2id = function(pkg, format) {
...
function generateId(obj) {
  obj = obj || {};
  var format = '{{root}}/{{name}}/{{version}}/{{filename}}';
  if (obj.spm && obj.spm.format) {
    format = obj.spm.format;
  } else if (obj.format) {
    format = obj.format;
  }
  var regex = /\{\{(.*?)\}\}/g, ret = format;
