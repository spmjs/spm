...
// alias
exports.defines = function(ast, obj) {
  if (!obj) return parseDefines(ast);
  return replaceDefine(ast, obj.id, obj.dependencies);
};
exports.requires = function(ast, fn) {
  if (!obj) return getRequires(ast);
  return replaceRequire(ast, fn);
};
exports.replace = replaceAll;
