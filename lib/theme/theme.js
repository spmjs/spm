...
module.exports = function(nico) {
  ...
  var getSourceFiles = require('../../lib/sdk/module').getSourceFiles;
  var getSpecFiles = require('../../lib/sdk/module').getSpecFiles;
  ...
  exports.functions = {
    ...
    spec_files: function() {
      return getSpecFiles().filter(function(item) {
    ...
    dependencies: function() {
      ...
      if (pkg.spm) {
        ...
        Object.keys(dependencies).forEach(function(key) {
          ret[key] = findEntryPoint(SEA_MODULES + '/' + key + '/' + dependencies[key]);
        });
        Object.keys(devDependencies).forEach(function(key) {
          ret[key] = findEntryPoint(SEA_MODULES + '/' + key + '/' + devDependencies[key]);
        });
      }
      return ret;
    },
